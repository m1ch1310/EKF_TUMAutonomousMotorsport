...
class EKF_Frenet:
    def __init__(self, x_init, params, sensor_init, ego_init):
        ...
        self.kf.F[2, 7] = self.dt_s  # yaw' = yaw + yaw_rate * dt
...
if __name__ == "__main__":
    ...
    params = {
        "timestep_s": dt,
        "P_init": np.eye(8) * 0.7,
        "measure_covs_dict": {"lidar": np.diag([0.015, 0.08])},
        "H_indices": {"lidar": ([0, 1], [0, 1])},
        "process_noise": [0.05, 0.045, 0.0018, 0.0018, 0.0007, 0.00008, 0.00005, 0.00002]
    }
    
    x_init = [df_lidar["s_global"].iloc[0], df_lidar["d_global"].iloc[0], 0, 0, 0, yaw_rate[0], 0, 0]
...
df_lidar.to_excel(r'C:\Users\2d\Engineering\Studium\Master\3Semester\Semesterarbeit\ekf8.4_vd_dynamicH_turnrate.xlsx', index=False)
