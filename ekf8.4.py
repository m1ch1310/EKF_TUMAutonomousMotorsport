...
if __name__ == "__main__":
    ...
    params = {
    "timestep_s": dt,
    "P_init": np.eye(6) * 0.7,  # Weitere Reduzierung der Anfangskovarianz für noch stabilere Schätzungen
    "measure_covs_dict": {"lidar": np.diag([0.015, 0.08])},  # Noch geringere Messunsicherheiten für s
    "H_indices": {"lidar": ([0, 1], [0, 1])},
    "process_noise": [0.05, 0.045, 0.0018, 0.0018, 0.0007, 0.00008]  # Weiter optimiertes Prozessrauschen für s
}
...
df_lidar.to_excel(r'C:\Users\2d\Engineering\Studium\Master\3Semester\Semesterarbeit\ekf8.4_input_sd.xlsx', index=False)
