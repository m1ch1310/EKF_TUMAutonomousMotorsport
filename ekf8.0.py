...
if __name__ == "__main__":
    ...
    params = {
        "timestep_s": dt,
        "P_init": np.eye(6) * 1.5,  # Geringere Anfangskovarianz für stabilere Schätzungen
        "measure_covs_dict": {"lidar": np.diag([0.08, 0.15])},  # Weiter reduzierte Messunsicherheiten
        "H_indices": {"lidar": ([0, 1], [0, 1])},
        "process_noise": [0.08, 0.08, 0.005, 0.005, 0.002, 0.0002]  # Weiter reduzierte Prozessrauschwerte
    }
    ...
    df_lidar.to_excel(r'C:\Users\2d\Engineering\Studium\Master\3Semester\Semesterarbeit\ekf8_input_sd.xlsx', index=False)
