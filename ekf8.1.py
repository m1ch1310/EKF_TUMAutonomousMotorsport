...
if __name__ == "__main__":
    ...
    "measure_covs_dict": {"lidar": np.diag([0.05, 0.1])},  # Geringere Messunsicherheiten
    "H_indices": {"lidar": ([0, 1], [0, 1])},
    "process_noise": [0.05, 0.05, 0.003, 0.003, 0.001, 0.0001]  # Reduziertes Prozessrauschen
}
...
df_lidar.to_excel(r'C:\Users\2d\Engineering\Studium\Master\3Semester\Semesterarbeit\ekf8.1_input_sd.xlsx', index=False)